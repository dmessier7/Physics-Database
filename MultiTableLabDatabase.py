...
Features:
    Main Menu
        ...
        Add Item (adds Item to the Item Database)
            -UI should show similar Items while you type in the name of the new one,
...
Coding
Location is a Class X
Function Edit Quantity X
Function Edit Location X
Function Edit Description X
Function Edit Name X
Item is a Class
    ItemID
    string Name
    string Description
